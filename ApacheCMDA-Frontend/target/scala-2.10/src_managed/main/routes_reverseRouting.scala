...
def CheckUser : JavascriptReverseRoute = JavascriptReverseRoute(
   "controllers.UserController.CheckUser",
   """
      function() {
...
def AddUser(): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   controllers.UserController.AddUser(), HandlerDef(this, "controllers.UserController", "AddUser", Seq(), "POST", """""", _prefix + """register""")
)
...
// @LINE:9
def CheckUser(): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   controllers.UserController.CheckUser(), HandlerDef(this, "controllers.UserController", "CheckUser", Seq(), "POST", """""", _prefix + """login""")
)
                      

// @LINE:12
def mainpage(): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   controllers.UserController.mainpage(), HandlerDef(this, "controllers.UserController", "mainpage", Seq(), "GET", """""", _prefix + """mainpage""")
)
                      

// @LINE:10
def register(): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   controllers.UserController.register(), HandlerDef(this, "controllers.UserController", "register", Seq(), "GET", """""", _prefix + """register""")
)
                      

// @LINE:8
def login(): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   controllers.UserController.login(), HandlerDef(this, "controllers.UserController", "login", Seq(), "GET", """""", _prefix + """login""")
)
