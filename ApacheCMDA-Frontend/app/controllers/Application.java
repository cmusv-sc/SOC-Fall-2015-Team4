...
public class Application extends Controller {
	...
	public static JsonNode validate(String email,String password) {
	...
	public static Result authenticate() {
		...
		JsonNode validation = validate(email,password);
	    ...
	    if (validation == null) {
	        ...
	        session().clear();
	        session("email", email);
			session("userId",validation.path("id").asText());
			session("firstName",validation.path("firstName").asText());
			session("lastName",validation.path("lastName").asText());
			session("researchFields",validation.path("researchFields").asText());
